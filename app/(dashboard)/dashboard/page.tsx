  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-1">Here is your schedule for today.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-slate-500 dark:text-slate-400">Total Today</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold text-slate-900 dark:text-slate-50">{totalToday}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-slate-500 dark:text-slate-400">Upcoming</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-50 mt-8 mb-4">Appointments</h2>
      ...
      {typedBookings.length === 0 ? (
        <Card className="flex flex-col items-center justify-center p-12 text-center border-dashed">
          ...
          <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-50">No appointments today</h3>
            ...
            return (
              <Card key={booking.id} className="overflow-hidden">
                <div className="flex flex-col sm:flex-row">
                  {/* Time section */}
                  <div className="bg-slate-50 dark:bg-slate-900/50 border-r border-slate-100 dark:border-slate-800 p-4 flex flex-col justify-center min-w-[140px]">
                  ...
                  <div className="p-4 flex-1 flex flex-col justify-center">
                    <div className="flex items-start justify-between">
                      <div>
                        <h4 className="font-semibold text-slate-900 dark:text-slate-50 text-lg">{booking.customer_name}</h4>
                        <p className="text-slate-500 dark:text-slate-400">{booking.services?.name}</p>
                      </div>
                  ...
                  {/* Actions section */}
                  <div className="p-4 bg-slate-50 dark:bg-slate-900/50 border-l border-slate-100 dark:border-slate-800 flex items-center justify-end sm:justify-center min-w-[180px]">
