...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 font-sans text-slate-900 dark:text-slate-50 scroll-smooth">
      {/* 1. NAVBAR */}
      <nav className="fixed top-0 left-0 right-0 bg-white dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-100 dark:border-slate-800 z-50">
      ...
      <main className="pt-16">
        ...
        <section className="relative pt-24 pb-20 lg:pt-36 lg:pb-28 overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a 
                href="#how-it-works" 
                className="w-full sm:w-auto px-8 py-4 text-base font-semibold text-slate-700 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl hover:border-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 dark:bg-slate-900/50 transition-all flex items-center justify-center"
              >
                See how it works
              </a>
            </div>
        ...
        <section id="features" className="py-24 bg-white dark:bg-slate-900 scroll-mt-16">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">Powerful, simple tools designed specifically for Indian service professionals.</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={i} className="bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow group">
        ...
        {/* 5. HOW IT WORKS */}
        <section id="how-it-works" className="py-24 bg-slate-50 dark:bg-slate-900/50 scroll-mt-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">How it works</h2>
              <p className="text-lg text-slate-600 dark:text-slate-400">Get up and running in minutes, not days.</p>
            </div>
            ...
            <div className="space-y-12 relative before:absolute before:inset-0 before:ml-8 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-200 before:to-transparent">
              {[
                ...
                <div key={i} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                  ...
                  <div className="w-[calc(100%-5rem)] md:w-[calc(50%-3rem)] bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm">
        ...
        {/* 6. PRICING */}
        <section id="pricing" className="py-24 bg-white dark:bg-slate-900 scroll-mt-16">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">Simple, transparent pricing</h2>
              <p className="text-lg text-slate-600 dark:text-slate-400">Start for free, upgrade when you need to.</p>
            </div>

            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {/* Free Plan */}
              <div className="border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-sm flex flex-col">
                <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-50 mb-2">Free Plan</h3>
                <div className="mb-6">
                ...
                <Link 
                  href="/login" 
                  className="w-full py-3.5 px-4 bg-slate-100 hover:bg-slate-200 text-slate-900 dark:text-slate-50 font-semibold rounded-xl text-center transition-colors"
                >
                  Get started free
                </Link>
              </div>
              ...
              {/* Pro Plan */}
              <div className="border-2 border-blue-700 rounded-3xl p-8 shadow-lg relative flex flex-col bg-white dark:bg-slate-900">
                ...
                <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-50 mb-2">Pro Plan</h3>
                <div className="mb-6">
      ...
      <footer className="border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold tracking-tight text-slate-900 dark:text-slate-50">BookZy</span>
            <span className="text-slate-400 text-sm ml-2">| Made for Indian businesses</span>
          </div>
          
          <div className="flex gap-6 text-sm text-slate-500 dark:text-slate-400">
            <a href="#" className="hover:text-slate-900 dark:text-slate-50 transition-colors">Privacy Policy</a>
            <a href="#" className="hover:text-slate-900 dark:text-slate-50 transition-colors">Terms of Service</a>
          </div>
